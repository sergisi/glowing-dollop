...
\]
Given all the privacy scores of the different rings using a specific Zipf distribution, then is calculated the average of an specific member of them in order to compare, in general terms, the privacy between different Zipf distributions and the different ring-signature methods.
\section{s: 1,3}
\begin{figure}[H] 
	\centering
